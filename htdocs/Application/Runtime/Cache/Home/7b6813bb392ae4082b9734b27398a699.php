...
<html>
	...
	<body>
		...
		<div class="qualificationabout_nav">
			<div><a class="bg" href="<?php echo U('Home/Index/intro_intro');?>?type=1">公司简介</a></div>
		...
		<div class="profile_content">
			<h2>公司简介</h2>
			<img alt="" src="/Public/Home/images/profilephoto-1.png">
			<div class="feiwu" style="width:500px;">
