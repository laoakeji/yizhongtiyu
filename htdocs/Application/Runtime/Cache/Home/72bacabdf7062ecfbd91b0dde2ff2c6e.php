	...
	<body>
		...
		<div class="flash3">
			<div class="flash4">
				<div class="flash5">
					<div class="tops2"></div>
					<div class="flash6"><img src="/Public/Home/picture/service.jpg"></div>
					<ul class="service_menu">
						<?php if(is_array($serlist)): $i = 0; $__LIST__ = $serlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="service_menu<?php echo ($vo["id"]); ?>"><a href="<?php echo U('Home/Index/service');?>?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
					<p class="clear"> </p>
				</div>
			</div>
		...
		<div class="about_title">
			<a id="company"><img class="ai" src="/Public/Home/picture/about_tb.jpg"><span>一站式服务 SERVICE</span></a>
			<p>省心省力，贴心服务</p>
		</div>
		<h1 class="h24 alignc"><?php echo ($list["name"]); ?></h1>
