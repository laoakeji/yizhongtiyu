...
<html>
	...
	<body>
		...
		<div class="nav_out">
			<div class="nav">
				<ul>
					...
					<li class="this"><a href="<?php echo U('Home/Index/intro_intro');?>?type=1">关于亿众</a></li>
		...
		<script>
			...
			<img class="banner" alt="" src="<?php echo ($imgdlist[0]["img_url"]); ?>">
		

		<div class="teamabout">
			<div><a href="<?php echo U('Home/Index/intro_intro');?>?type=1">公司简介</a></div>
			<div><a href="<?php echo U('Home/Index/intro_intro');?>?type=2">公司团队</a></div>
			<div><a class="bg" href="<?php echo U('Home/Index/intro_story');?>">品牌故事</a></div>
			<div><a href="<?php echo U('Home/Index/intro_intro');?>?type=4">公司资质</a></div>
			<div><a href="<?php echo U('Home/Index/intro_intro');?>?type=5">合作客户</a></div>
			<img alt="" src="/Public/Home/images/nav-1.jpg">
		</div>
		...
		<div class="about_title">
			<a id="brand"><img style=" position:relative; left:400px;; top:40px;;" src="/Public/Home/picture/about_tb.jpg" /><span>品牌故事 BRAND</span></a>
			<p>运动就要酷到底，运动点燃生活，爱运动,真快乐</p>
		</div>
		<!--标题结束-->
		<div class="width1 about_brand_bg">
			<ul class="about_brand">
				<li>
				</li>
				
				<?php $a=1; ?>
				<?php if(is_array($yearlist)): $i = 0; $__LIST__ = $yearlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="brand3">
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i; if($vol['yearid'] == $vo['id']): if($a == 1): ?><h1><?php echo ($vol["content"]); ?></h1>
									<h2><?php echo (date('Y-m-d',$vol["time"])); ?></h2>
									<p class="clear"><br /></p>
									<?php $a=2; ?>
								<?php else: ?>
									<h4><?php echo (date('Y-m-d',$vol["time"])); ?></h4>
									<h5><?php echo ($vol["content"]); ?></h5>
									<p class="clear"><br /></p>
									<?php $a=1; endif; endif; endforeach; endif; else: echo "" ;endif; ?>
		...
		<div class="width1 about_brands"><img style=" position:relative; left:585px;; top:0;" src="/Public/Home/picture/about_brand_dian2.jpg" /><br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2016更多奇迹，等你来创造！！！
		</div>
		<!--脚注开始-->
		<div class="clear"> </div>
