...
<html>
	...
	<body>
		...
		<div>
			<img class="banner" alt="" src="/Public/Home/images/about.jpg">
		</div>

		<div class="qualificationabout_nav">
			...
			<div><a href="<?php echo U('Home/Index/intro_story');?>">品牌故事</a></div>
			<div><a class="bg" href="<?php echo U('Home/Index/intro_intro');?>?type=4">公司资质</a></div>
		...
		<!-- <div class="qualification_content">
			<h2><?php echo ($list["typename"]); ?></h2>
			<div>
				<img alt="" src="/Public/Home/images/qualificationphoto-1.jpg">
				<h3>湖北省策划协会副秘书长单位</h3>
			</div>
			<div>
				<img alt="" style=" margin-left:100px; margin-right:100px;" src="/Public/Home/images/qualificationphoto-02.png">
				<h3>中网网动中国优秀<br/>合作伙伴</h3>
			</div>
			<div>
				<img alt="" src="/Public/Home/images/qualificationphoto-3.jpg">
				<h3>湖北省策划协会副秘书长单位</h3>
			</div>
