...
<html>
	...
	<body>
		...
		<img class="banner img" src="/Public/Home/images/case.jpg">

		<div class="wenzi789">
			<h2 style=" font-size:26px; font-weight:900;"><?php echo ($list["title"]); ?></h2>
			<div class="pei789">
				<p>发布时间:<?php echo (date("Y-m-d",$list["ptime"])); ?>&nbsp;&nbsp;发布人:<?php echo ($list["author"]); ?>&nbsp;&nbsp;点击量:<?php echo ($list["count"]); ?> </p>
			</div>
		</div>
		
		<div class="neirong789">
			<p><?php echo ($list["content"]); ?></p>
		</div>

		<div class="qiehuan789">
			<a href="<?php echo U('Home/Index/cases');?>" class="shuzi456" href="">返回</a>
		</div>
		<!--脚注开始-->
		<div class="clear"> </div>
