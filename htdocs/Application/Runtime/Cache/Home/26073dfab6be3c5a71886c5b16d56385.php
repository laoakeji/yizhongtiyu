...
<html>
	...
	<body>
		...
		<div class="width1 run_title">
			<img src="/Public/Home/picture/run_road_title.jpg">
		...
		<div class="run_road_pic">
			<ul>
				<?php $a=1 ;?>
				<?php if(is_array($roadlist)): $i = 0; $__LIST__ = $roadlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<?php if($a == 1 ): ?><h1><img src="<?php echo ($vo["image"]); ?>"></h1>
							<h2><span><?php echo ($vo["title"]); ?></span>
							<font><?php echo ($vo["desc"]); ?></font></h2>
							<?php $a=2 ;?>
						<?php else: ?> 
							<h2><span><?php echo ($vo["title"]); ?></span> 
							<font><?php echo ($vo["desc"]); ?><br></font></h2>
							<h1><img src="<?php echo ($vo["image"]); ?>"></h1>
							<?php $a=1 ; endif; ?>
