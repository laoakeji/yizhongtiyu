...
<div class="pd-20">
    ...
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>服务热线：</label>
    ...
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>版权所有：</label>
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["copy"]); ?>" name="copy" id="copy">
      </div>   
    </div>
    
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>技术支持：</label>
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["tech"]); ?>" name="tech" id="tech">
      </div>   
    </div>
    
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>技术链接：</label>
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["url"]); ?>" name="url" id="url">
      </div>   
    </div>
	...
	<script type="text/javascript">
			$(function(){
				$('#sub_form2').click(function(){
					...
					var id="<?php echo ($id); ?>";
					$.post("<?php echo U('Index/do_edit_copyright');?>?id="+id,data,function(data){
						if (data>=1) {
							//layer.msg("修改成功");
              alert("修改成功");
