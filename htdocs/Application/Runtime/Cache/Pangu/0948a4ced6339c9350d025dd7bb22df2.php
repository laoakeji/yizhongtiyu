...
<div class="cl pd-5 bg-1 bk-gray mt-20"> 
  ...
  <a class="btn btn-primary radius" onclick="admin_add('添加','<?php echo U('Pangu/Index/edit');?>?table=pro_road&type=<?php echo ($type); ?>','1000','600')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加</a>
   </span>
</div>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
          ...
          <th width="120">操作</th>
			...
			<tbody>
				<?php if(is_array($roadlist)): $i = 0; $__LIST__ = $roadlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
          ...
          <td><?php echo ($vo["type"]); ?></td>
					<td class="f-14 td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="admin_edit('编辑','<?php echo U('Index/edit');?>?table=pro_road&type=<?php echo ($type); ?>&id=<?php echo ($vo["id"]); ?>','1000','800')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
$(function(){
  $(".del_all").click(function(){
      ...
      $(".hidden-xs").each(function(){
          ...
          $.get("<?php echo U('Index/do_del_all');?>?table=pro_road&ids="+ids,function(data,s){
  ...
  $(".w_del").click(function(){
    ...
    $.post("<?php echo U('Index/do_del');?>",{id:id,table:"pro_road"},function(data){
      if (data==1) {
      alert("删除成功")     
