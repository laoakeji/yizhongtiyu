...
<div class="cl pd-5 bg-1 bk-gray mt-20"> 
  <a class="btn btn-primary radius" onclick="admin_add('添加','<?php echo U('Pangu/Index/edit');?>?table=yzser&type=<?php echo ($type); ?>','800','800')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加</a>
   </span> 
</div>
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td><?php echo ($vo["name"]); ?></td>
          			<td><img src="<?php echo ($vo["icon"]); ?>" style="width:120px;height: 60px"></td>
          			<td><img src="<?php echo ($vo["icon2"]); ?>" style="width:120px;height: 60px"></td>
					<td><?php echo ($vo["sort"]); ?></td>
					<td class="f-14 td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="admin_edit('编辑','<?php echo U('Index/edit');?>?table=yzser&type=<?php echo ($type); ?>&id=<?php echo ($vo["id"]); ?>','1000','800')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
