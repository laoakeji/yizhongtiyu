...
<div class="pd-20">
    ...
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>类型ID：</label>
      <div class="formControls col-8">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["typeid"]); ?>" name="typeid" id="typeid">
      </div>   
    </div>
	...
	<script type="text/javascript">
			$(function(){
				$('#sub_form2').click(function(){
					...
					var id="<?php echo ($id); ?>";
					$.post("<?php echo U('Index/do_edit');?>?table=pro_dlist&id="+id,data,function(data){
						if (data>=1) {
							//layer.msg("修改成功");
              alert("修改成功");
